...
window.DEVTOOL_WASM_MODULE_FACTORY = function () {
  var e, r = void 0,
    ...
    t = (e = "undefined" != typeof document && document.currentScript ? document.currentScript.src : void 0, function (r) {
      ...
      var p, d, E, _, b, g, v, y, A = "undefined" != typeof TextDecoder ? new TextDecoder("utf8") : void 0;
      ...
      function O() {
        r.HEAP8 = d = new Int8Array(p), r.HEAP16 = _ = new Int16Array(p), r.HEAP32 = g = new Int32Array(p), r.HEAPU8 = E = new Uint8Array(p), r.HEAPU16 = b = new Uint16Array(p), r.HEAPU32 = v = new Uint32Array(p), r.HEAPF32 = y = new Float32Array(p), r.HEAPF64 = new Float64Array(p)
      }
      ...
      C < B && u("TOTAL_MEMORY should be larger than TOTAL_STACK, was " + C + "! (TOTAL_STACK=5242880)"), r.buffer ? p = r.buffer : "object" === _typeof(__realWebAssembly) && "function" == typeof __realWebAssembly.Memory ? (o = new __realWebAssembly.Memory({
        initial: C / 65536
      }), p = o.buffer) : p = new ArrayBuffer(C), O(), g[2960] = 5254976;
      var N = [],
        w = [],
        F = [],
        M = [],
      ...
      function J(e) {
        ...
        function t(e, n) {
          ...
          r.asm = t,
            function (e) {
              if (W--, r.monitorRunDependencies && r.monitorRunDependencies(W), 0 == W && (null !== q && (clearInterval(q), q = null), j)) {
                var n = j;
                j = null, n()
              }
            }()
      ...
      var $ = {
        ...
        ee = {
          ...
          varargs: 0,
          get: function (e) {
            return ee.varargs += 4, g[ee.varargs - 4 >> 2]
          },
          getStr: function () {
            return I(ee.get())
          },
      ...
      function fe(e, r, n, t) {
        for (var a = 0; a < e; a++) {
          var i = de[n](),
            u = i && ne.getNewId(t);
          i ? (i.name = u, t[u] = i) : ne.recordError(1282), g[r + 4 * a >> 2] = u
        }
      }
      ...
      function me(e, r, n, t, a, i) {
        var u = le[r] * ce[e];
        if (u) {
          var o = a + function (e, r, n, t) {
            var a;
            return r * (e * n + (a = t) - 1 & -a)
          }(n, t, u, ne.unpackAlignment);
          switch (e) {
            case 5120:
              return d.subarray(a, o);
            case 5121:
              return E.subarray(a, o);
            case 5122:
              return _.subarray(a >> 1, o >> 1);
            case 5124:
              return g.subarray(a >> 2, o >> 2);
            case 5126:
              return y.subarray(a >> 2, o >> 2);
            case 5125:
            case 34042:
            case 35902:
            case 33640:
      ...
      var be = {
          ...
          U: function (e) {
            return r.___errno_location && (g[r.___errno_location() >> 2] = e), e
          },
          Ja: function (e, r) {
            ee.varargs = r;
            try {
              var n = ee.getStreamFromFD(),
                ...
                i = ee.get(),
                u = t;
              return FS.llseek(n, u, i), g[a >> 2] = n.position, n.getdents && 0 === u && 0 === i && (n.getdents = null), 0
            } catch (e) {
          ...
          Q: function (e, r) {
            ...
            try {
              for (var n = ee.get(), t = ee.get(), a = ee.get(), i = 0, u = 0; u < a; u++) {
                for (var o = g[t + 8 * u >> 2], f = g[t + (8 * u + 4) >> 2], s = 0; s < f; s++) ee.printChar(n, E[o + s]);
                i += f
              }
              return i
            } catch (e) {
          ...
          C: function (e, r) {
            return function (e, r) {
              var n = {},
                t = r >> 2;
              n.alpha = !!g[t + 0], n.depth = !!g[t + 1], n.stencil = !!g[t + 2], n.antialias = !!g[t + 3], n.premultipliedAlpha = !!g[t + 4], n.preserveDrawingBuffer = !!g[t + 5];
              var a = g[t + 6];
              n.powerPreference = ae[a], n.failIfMajorPerformanceCaveat = !!g[t + 7], n.majorVersion = g[t + 8], n.minorVersion = g[t + 9], n.enableExtensionsByDefault = g[t + 10], n.explicitSwapControl = g[t + 11], n.proxyContextToMainThread = g[t + 12], n.renderViaOffscreenBackBuffer = g[t + 13];
              var i = ue(e);
              return i ? n.explicitSwapControl ? 0 : ne.createContext(i, n) : 0
            }(e, r)
          },
          Va: function (e) {
            for (var r = e >> 2, n = 0; n < 14; ++n) g[r + n] = 0;
            g[r + 0] = g[r + 1] = g[r + 3] = g[r + 4] = g[r + 8] = g[r + 10] = 1
          },
          Ua: function (e) {
          ...
          p: function (e, r) {
            for (var n = oe[e], t = 0; t < e; t++) n[t] = g[r + 4 * t >> 2];
            de.drawBuffers(n)
          },
          Ba: function (e, r, n, t) {
          ...
          M: function (e, r) {
            ! function (e, r, n) {
              if (r) {
                ...
                switch (n) {
                  case "Integer64":
                    tempI64 = [t >>> 0, (tempDouble = t, +G(tempDouble) >= 1 ? tempDouble > 0 ? (0 | H(+V(tempDouble / 4294967296), 4294967295)) >>> 0 : ~~+X((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)], g[r >> 2] = tempI64[0], g[r + 4 >> 2] = tempI64[1];
                    break;
                  case "Integer":
                    g[r >> 2] = t;
                    break;
            ...
            if (n)
              if (e >= ne.counter) ne.recordError(1281);
                ...
                if (t)
                  if (35716 == r) {
                    var a = de.getProgramInfoLog(ne.programs[e]);
                    null === a && (a = "(unknown error)"), g[n >> 2] = a.length + 1
                  } else if (35719 == r) g[n >> 2] = t.maxUniformLength;
                else if (35722 == r) {
                  ...
                  g[n >> 2] = t.maxUniformBlockNameLength
                } else g[n >> 2] = de.getProgramParameter(ne.programs[e], r);
          ...
          L: function (e, r, n) {
            if (n)
              if (35716 == r) {
                ...
                null === t && (t = "(unknown error)"), g[n >> 2] = t.length + 1
              } else if (35720 == r) {
              var a = de.getShaderSource(ne.shaders[e]),
                i = null === a || 0 == a.length ? 0 : a.length + 1;
              g[n >> 2] = i
            } else g[n >> 2] = de.getShaderParameter(ne.shaders[e], r);
            else ne.recordError(1281)
          },
          pa: function (e) {
        ...
        ge = r.asm({}, be, p);
      r.asm = ge;
      var ve = r.__GLOBAL__sub_I_gfx_emsc_cc = function () {
      ...
      if (r.dynCall_v = function () {
          ...
          return r.asm.Xb.apply(null, arguments)
        }, r.asm = ge, r.ccall = m, r.cwrap = function (e, r, n, t) {
          ...
          return r
        }, Re.prototype = new Error, Re.prototype.constructor = Re, j = function e() {
          r.calledRun || Se(), r.calledRun || (j = e)
        }, r.callMain = function (e) {
          e = e || [], k();
          var n, t = e.length + 1,
            a = Te(4 * (t + 1));
          g[a >> 2] = P(r.thisProgram);
          for (var i = 1; i < t; i++) g[(a >> 2) + i] = P(e[i - 1]);
          g[(a >> 2) + t] = 0;
          try {
