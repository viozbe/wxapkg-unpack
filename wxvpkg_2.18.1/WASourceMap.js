  ...
  __wxSourceMapRetrace__ = function (e) {
    ...
    s.fromSourceMap = function (e, n) {
      ...
      for (var s = e._mappings.toArray().slice(), p = r.__generatedMappings = [], g = r.__originalMappings = [], f = 0, h = s.length; f < h; f++) {
        var m = s[f],
          d = new c;
        d.generatedLine = m.generatedLine, d.generatedColumn = m.generatedColumn, m.source && (d.source = a.indexOf(m.source), d.originalLine = m.originalLine, d.originalColumn = m.originalColumn, m.name && (d.name = o.indexOf(m.name)), g.push(d)), p.push(d)
      }
      ...
      for (var r, o, i, s, l, p = 1, g = 0, f = 0, h = 0, m = 0, d = 0, _ = e.length, y = 0, v = {}, A = {}, C = [], S = []; y < _;)
        if (";" === e.charAt(y)) p++, y++, g = 0;
        else if ("," === e.charAt(y)) y++;
      else {
        for ((r = new c).generatedLine = p, s = y; s < _ && !this._charIsMappingSeparator(e, s); s++);
        if (i = v[o = e.slice(y, s)]) y += o.length;
        else {
          for (i = []; y < s;) a.decode(e, y, A), l = A.value, y = A.rest, i.push(l);
        ...
        r.generatedColumn = g + i[0], g = r.generatedColumn, i.length > 1 && (r.source = m + i[1], m += i[1], r.originalLine = f + i[2], f = r.originalLine, r.originalLine += 1, r.originalColumn = h + i[3], h = r.originalColumn, i.length > 4 && (r.name = d + i[4], d += i[4])), S.push(r), "number" == typeof r.originalLine && C.push(r)
      }
    ...
    function y(e) {
      var n = g.exec(e);
      if (!n || n.length < 5) return function (e) {
        return p() && f.test(e)
      }(e) ? {
        origin: e,
        type: "native",
      ...
      var r = e.slice(0, n.index).trim(),
        o = "",
        i = r.match(h);
      i && (o = r.replace(h, "").replace(m, "") + "\n", r = i[1] || ""), 0 !== r.indexOf("at ") && (r = "at " + r);
      var a = n[2],
        u = t(function (e) {
          if (e.indexOf("/") > 0) {
            var n = e.split("/");
        ...
        return function () {
          if (!s && (s = !0, "object" === (void 0 === __wxSourceMap ? "undefined" : i(__wxSourceMap))))
            if (__wxSourceMap.get, "string" != typeof __wxSourceMap.__system);
              ...
              var e = t(__wxSourceMap.__system.toLowerCase().split(/\s+/), 2),
                n = e[0],
                r = e[1];
              u.platform = n, u.version = r
            }
        }(), "string" == typeof e.stack && (e.stack = e.stack.split("\n").map((function (e) {
